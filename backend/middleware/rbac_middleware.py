...
PERMISSION_MATRIX = {
    ...
    "ai:recompute": [Role.SYSTEM_ANALYST, Role.GOVERNMENT_AUTHORITY, Role.SYSTEM_ADMIN],
    "analytics:read": [Role.SYSTEM_ANALYST, Role.GOVERNMENT_AUTHORITY, Role.SYSTEM_ADMIN],
    "institution:read": [
        Role.SYSTEM_ADMIN, Role.INSTITUTION_ADMIN, Role.GOVERNMENT_AUTHORITY,
    ],
    "institution:write": [Role.SYSTEM_ADMIN],
    "institution:portal": [Role.INSTITUTION_ADMIN, Role.SYSTEM_ADMIN],
    "institution:manage_own": [Role.INSTITUTION_ADMIN],
    "transport:portal": [Role.TRANSPORT_OPERATOR, Role.SYSTEM_ADMIN],
    "transport:manage_routes": [Role.TRANSPORT_OPERATOR, Role.SYSTEM_ANALYST, Role.SYSTEM_ADMIN],
    "government:portal": [Role.GOVERNMENT_AUTHORITY, Role.SYSTEM_ADMIN],
    "government:issue_warning": [Role.GOVERNMENT_AUTHORITY, Role.SYSTEM_ANALYST, Role.SYSTEM_ADMIN],
